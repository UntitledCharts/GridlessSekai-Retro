...
> [!TIP]
> If you wish to be notified of updates, **👁️ Watch** the project and get emails for every release.
...
Sending your logs may be useful. See [LOGS.md](LOGS.md) for more info.
